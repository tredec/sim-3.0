...
class efSim {
    constructor(data) {
        ...
        this.variables = [
            ...
            new Variable({ cost: 20, costInc: 200, value: 1, stepwisePowerSum: { default: true }, firstFreeCost: true }),
            new Variable({ cost: 100, costInc: 2, varBase: 1.1 }),
            new Variable({ cost: 2000, costInc: Math.pow(2, 2.2), value: 1, stepwisePowerSum: { default: true } }),
    ...
    simulate(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            while (!pubCondition) {
                ...
                this.buyVariables();
                pubCondition =
                    ((global.forcedPubTime !== Infinity ? this.t > global.forcedPubTime : this.t > this.pubT * 2 || this.pubRho > this.cap[0] || this.evaluatePubConditions()) && this.pubRho > 10) || this.pubRho > 325;
                this.ticks++;
            }
    ...
    tick() {
        ...
        if (this.maxTauH < this.tauH || this.maxRho >= this.cap[0] - this.cap[1] || this.pubRho < 10 || global.forcedPubTime !== Infinity || true) {
