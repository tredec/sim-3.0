...
class ltSim {
    constructor(data) {
        ...
        this.maxRho = 0;
        this.t_var = 0;
        this.s = l10((1 + Math.pow(5, 0.5)) / 2 - 1);
    ...
    updateMilestones() {
        ...
        if (this.variables[6].varBase !== 10 * Math.pow(10, this.milestones[2])) {
            this.variables[6].varBase = 10 * Math.pow(10, this.milestones[2]);
    ...
    tick() {
        ...
        if (this.laplaceActive) {
            ...
            this.currencies[0] = add(this.currencies[0], bonus + this.variables[0].value * (1 + 0.05 * this.milestones[0]) + this.variables[1].value + this.variables[6].value * (1 + 0.1 * this.variables[7].level) + q + ldt);
        }
